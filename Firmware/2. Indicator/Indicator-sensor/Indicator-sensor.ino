...
Adafruit_NeoPixel indicator(9, 3, NEO_GRB + NEO_KHZ800);
  ...
  //esp-now stuff
uint8_t broadcastAddress[] = {0x1C, 0xDB, 0xD4, 0x44, 0x51, 0x7C};   //MAC Address format 11:22:33:44:55:66 (MAC of your sensor for sending back which color is shown every time it's changed)
